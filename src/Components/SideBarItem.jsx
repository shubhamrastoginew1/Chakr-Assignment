            ...
            <div className='sidebar-icon'>
                {(() => {
                    switch (item) {
                        case 1:
                            return (
                                <svg style={{ marginRight: '0.7rem' }} xmlns="http://www.w3.org/2000/svg" width="25" height="26" viewBox="0 0 16 16" fill="none">
                        ...
                        case 2:
                            return (
                                <svg style={{ marginRight: '0.7rem' }} xmlns="http://www.w3.org/2000/svg" width="25" height="26" viewBox="0 0 16 17" fill="none">
                        ...
                        case 8:
                            return (
                                <div style={{ marginRight: '0.7rem' }} className="avatar">
                ...
                switch (item) {
                    ...
                    case 8:
                        return (
                            <div>
                                <p>Gustavo Xavier</p>
                                <p style={{ backgroundColor: "#FFCD71", width: "fit-content", padding: "0rem 0.375rem", borderRadius: '1.5rem' }}>Admin</p>
                            </div>
                        )
                    case 9:
                        return (
